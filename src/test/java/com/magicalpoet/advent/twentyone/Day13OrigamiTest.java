...
class Day13OrigamiTest {
    ...
    static void readFiles() throws Exception {
        TEST_INPUT = utils.readFileToString("2021/day13TestInput.txt");
        REAL_INPUT = utils.readFileToString("2021/day13Input.txt");
        TEST_FOLDS = "fold along y=7\nfold along x=5";
        REAL_FOLDS = utils.readFileToString("2021/day13FoldInstructions.txt");
    }
